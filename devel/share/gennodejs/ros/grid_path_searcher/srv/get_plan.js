...
// (in-package grid_path_searcher.srv)
...
class get_planRequest {
  ...
  static datatype() {
    ...
    return 'grid_path_searcher/get_planRequest';
  }
...
class get_planResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'grid_path_searcher/get_planResponse';
  }
...
module.exports = {
  ...
  md5sum() { return '647c71abdcf22e8d9ecf2dcc45d55169'; },
  datatype() { return 'grid_path_searcher/get_plan'; }
};
